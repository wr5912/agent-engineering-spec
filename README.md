...
7. **失败样本持续回流**：真实运行中的失败、偏差和高价值反馈应转化为新的测试或回归样本，使研发资产随实际使用持续积累。
...
| `04_评估测试与回归规范.md` | 规定能力评估、测试集、回归、失败样本管理与发布门槛 | **核心验证** |
...
- **探索验证阶段**：重点完成需求、代表性场景、最小实验和基础评估，快速判断方向是否成立；
